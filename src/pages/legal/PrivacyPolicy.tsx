...
<ul className="list-disc ml-6 space-y-3">
  ...
  <li>
    <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to
    ITERAC Solutions Private Limited, B-1202, Spring Meadows, Bishrakh, Gautam Buddha Nagar, 201306, UP, INDIA.
  </li>
  ...
  <li>
    <strong>Personal Data</strong> (or "Personal Information") is any information that relates to an identified or identifiable
    individual.
    <br />
  ...
  <li>
    <strong>Website</strong> refers to ITERAC, accessible from <a href="http://iterac.com" className="text-blue-600 underline">http://iterac.com</a>.
  </li>
...
<li>
    ...
    <div className="ml-4 mt-2 space-y-1">
      ...
      <p>
        ...
        You with a more personal experience and to avoid You having to re-enter your preferences every time You
        use the Website.
      </p>
    </div>
  </li>
...
<ul className="list-disc ml-6 mt-3 space-y-3">
  ...
  <li>
    ...
    otherwise interact in the public areas with other users, such information may be viewed by all users and
...
<ul className="list-disc ml-6 mt-4 space-y-2">
  ...
  <li>
    ...
    <ul className="list-disc ml-6 mt-2 space-y-1">
      <li>
        <span className="ml-2">
          <strong>User Accounts:</strong> retained for the duration of your account relationship plus up to
          24 months after account closure to handle any post-termination issues or resolve disputes.
        </span>
      </li>
    </ul>
  </li>
  ...
  <li>
    ...
    <ul className="list-disc ml-6 mt-2 space-y-1">
      <li>
        <span className="ml-2">
          <strong>Support tickets and correspondence:</strong> up to 24 months from the date of ticket closure
          to resolve follow-up inquiries, track service quality, and defend against potential legal claims.
        </span>
      </li>
      <li>
        <span className="ml-2">
  ...
  <li>
    ...
    <ul className="list-disc ml-6 mt-2 space-y-1">
      <li>
        <span className="ml-2">
          <strong>Website analytics data</strong> (cookies, IP addresses, device identifiers): up to 24 months
          from the date of collection, which allows us to analyze trends while respecting privacy principles.
        </span>
      </li>
      <li>
        <span className="ml-2">
          <strong>Server logs</strong> (IP addresses, access times): up to 24 months for security monitoring
...
<ul className="list-disc ml-6 mt-2 space-y-2">
  ...
  <li>
    <strong>Backup retention:</strong> Residual copies may remain in encrypted backups for a limited period consistent
    with our backup retention schedule and are not restored except where necessary for security, disaster recovery,
    or legal compliance.
  </li>
  <li>
